...
docker pull ditel89/light-control:v1.3
...
echo "docker run -it --name light-control --rm --device=/dev/ttyTHS0 --env-file config.cfg ditel89/light-control:v1.3" > run_cmdLigth.sh
